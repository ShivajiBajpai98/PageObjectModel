...
public class TestConfig{
	...
	public static String from = "shivajibajpai@atmecs.com";
	public static String password = "Selenium@123";
	public static String[] to ={"Velssir@gmail.com","Senthilsir@gmail.com"};
	public static String subject = "Test Report";
	
	public static String messageBody ="TestMessage";
	public static String attachmentPath="C:\\Use\\Dedevopsimg.jpg";
